...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.listGroup = ['A_Attribute', 'C_Attribute', 'F_Attribute', 'H_Attribute', 'M_Attribute', 'B_Attribute', 'O_Attribute', 'N_Attribute', 'R_Attribute', 'T_Attribute', 'U_Attribute', 'Z_Attribute']
        nameFile = self.pathInput+"P_Attribute/normaliced/dataSetNormaliced.csv"
    ...
    def createPredictForGroup(self, group):
        ...
        listDesc = ['BernoulliNB', 'GaussianNB']
        listAlgth = 'naive_bayes'
        actualData = 0.6923076923076923
