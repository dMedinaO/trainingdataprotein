...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.listGroup = ['A_Attribute', 'C_Attribute', 'F_Attribute', 'H_Attribute', 'M_Attribute', 'B_Attribute', 'O_Attribute', 'P_Attribute', 'R_Attribute', 'T_Attribute', 'N_Attribute', 'Z_Attribute']
        nameFile = self.pathInput+"U_Attribute/normaliced/dataSetNormaliced.csv"
