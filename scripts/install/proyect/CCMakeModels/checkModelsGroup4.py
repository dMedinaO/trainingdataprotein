...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.ListName = ['group2_Full.csv','group1_Full.csv','group3_Full.csv','group5_Full.csv','group6_Full.csv','group7_Full.csv']
        self.listGroup = ['grupo2','grupo1','grupo3','grupo5','grupo6','grupo7']
    ...
    def createPredictForGroup(self, group, name):
        ...
        listDesc = ['minkowski-uniform KNN: 2', 'euclidean-uniform KNN: 2', 'minkowski-uniform KNN: 2', 'euclidean-uniform KNN: 2']
        listAlgth = ['auto', 'auto', 'ball_tree', 'ball_tree']
        #actualData = 0.79
        actualData = 0.57
