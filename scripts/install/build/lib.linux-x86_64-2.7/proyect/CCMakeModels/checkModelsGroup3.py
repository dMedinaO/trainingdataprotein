...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.ListName = ['group2_Full.csv','group1_Full.csv','group4_Full.csv','group5_Full.csv','group6_Full.csv','group7_Full.csv']
        self.listGroup = ['grupo2','grupo1','grupo4','grupo5','grupo6','grupo7']
