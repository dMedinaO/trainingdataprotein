...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.listGroup = ['A_Attribute', 'C_Attribute', 'F_Attribute', 'H_Attribute', 'M_Attribute', 'B_Attribute', 'O_Attribute', 'P_Attribute', 'R_Attribute', 'T_Attribute', 'U_Attribute', 'Z_Attribute']
        nameFile = self.pathInput+"N_Attribute/normaliced/dataSetNormaliced.csv"
