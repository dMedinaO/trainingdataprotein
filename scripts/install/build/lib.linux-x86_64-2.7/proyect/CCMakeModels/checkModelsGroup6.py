...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.ListName = ['group2_Full.csv','group1_Full.csv','group3_Full.csv','group4_Full.csv','group5_Full.csv','group7_Full.csv']
        self.listGroup = ['grupo2','grupo1','grupo3','grupo4','grupo5','grupo7']
    ...
    def createPredictForGroup(self, group, name):
        ...
        listAlgth = ['SVC', 'SVC', 'SVC']

        actualData = [0.575757575758, 0.575757575758, 0.575757575758]
