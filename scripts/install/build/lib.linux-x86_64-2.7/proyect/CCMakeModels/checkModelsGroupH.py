...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.listGroup = ['B_Attribute', 'C_Attribute', 'F_Attribute', 'A_Attribute', 'M_Attribute', 'N_Attribute', 'O_Attribute', 'P_Attribute', 'R_Attribute', 'T_Attribute', 'U_Attribute', 'Z_Attribute']
        nameFile = self.pathInput+"H_Attribute/normaliced/dataSetNormaliced.csv"
