...
from proyect.CCMakeGroups import generateRandomGroupFor13ElementCSS
...
generator = generateRandomGroupFor13ElementCSS.groupRandomGenerator(groups, pathOutputGroups, process.matrixData, process.header, iterator, dictGroup)
