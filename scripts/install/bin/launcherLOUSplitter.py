...
print "Process group: ", groupName

ListResultAlgorithm = []
#accedemos al directorio...
dirData = namePathInput+str(groupName)+"/"+str(groupName)+".csv"

process = procesFile.processDataSet(dirData, 'pathOutput', ',')
...
dirDataTraining = namePathInput+str(groupName)+"/training/"
