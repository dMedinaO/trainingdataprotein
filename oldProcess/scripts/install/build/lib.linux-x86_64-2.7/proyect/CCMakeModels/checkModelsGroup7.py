...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.ListName = ['group2_Full.csv','group1_Full.csv','group3_Full.csv','group4_Full.csv','group5_Full.csv','group6_Full.csv']
        self.listGroup = ['grupo2','grupo1','grupo3','grupo4','grupo5','grupo6']
    ...
    def createPredictForGroup(self, group, name):
        ...
        listDesc = ['GradientBoostingClassifier 20']
        #listAlgth = ['GradientBoostingClassifier', 'MLPClassifier', 'MLPClassifier' 'SVC', 'SVC', 'SVC', 'SVC', 'gini', 'gini', 'entropy']
        listAlgth = 'GradientBoostingClassifier'

        actualData = [0.846774193548]#, 0.838709677419,0.817903225806,0.805806451613,0.805806451613,0.805806451613,0.80564516129,0.805483870968,0.805483870968,0.80435483871]
        #actualData = [0.564516129032, 0.564516129032, 0.564516129032]
        ...
        # clf.append(GradientBoostingClassifier(n_estimators=1500))
        ...
        # clf.append(GradientBoostingClassifier(n_estimators=10))
        # clf.append(MLPClassifier(hidden_layer_sizes=(10,5,10), activation='logistic', solver='adam', learning_rate='invscaling'))
        # clf.append(MLPClassifier(hidden_layer_sizes=(10,10,15), activation='logistic', solver='adam', learning_rate='invscaling'))
        #clf.append(SVC(kernel='rbf', degree=3, gamma=10, probability=True))
        #clf.append(SVC(kernel='sigmoid', degree=3, gamma=10, probability=True))
        #clf.append(SVC(kernel='poly', degree=3, gamma=10, probability=True))
        # clf.append(DecisionTreeClassifier(random_state=0, criterion='gini', splitter='best'))
        # clf.append(DecisionTreeClassifier(random_state=0, criterion='gini', splitter='random'))
        # clf.append(DecisionTreeClassifier(random_state=0, criterion='entropy', splitter='random'))
