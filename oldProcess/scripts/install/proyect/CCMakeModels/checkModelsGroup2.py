...
class evaluacionCruzada(object):
    ...
    def __init__(self, pathInput, pathOutput):
        ...
        self.ListName = ['group1_Full.csv','group3_Full.csv','group4_Full.csv','group5_Full.csv','group6_Full.csv','group7_Full.csv']
        self.listGroup = ['grupo1','grupo3','grupo4','grupo5','grupo6','grupo7']
        nameFile = self.pathInput+"grupo2/group2_Full.csv"
    ...
    def createPredictForGroup(self, group, name):
        ...
        listDesc = ['logistic-adam-invscaling (10-5-10)']
